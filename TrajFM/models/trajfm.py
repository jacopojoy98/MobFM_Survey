...
class TrajFM(nn.Module):
    def __init__(self, embed_size, d_model, poi_embed, poi_coors, rope_layer, UTM_region, spatial_middle_coord, scale):
    ...
    def loss(self, input_seq, target_seq, positions):
        ...
        pred_spatial, pred_temporal_token, pred_token_dist = self.pred(mem_seq)
    ...
    def test(self, input_seq, target_seq, positions):
        ...
        pred_spatial, pred_temporal_token, pred_token = self.pred(mem_seq, return_raw=False)
