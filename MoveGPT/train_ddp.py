...
def main_ddp():
    ...
    # 训练和验证
    train_stop_ddp(model, train_loader, val_loaders, log_dir, args.lr, args.epoch, valid_step_interval, device, args.target_city, patience=3)
...
if __name__ == "__main__":
    main_ddp()
    # CUDA_VISIBLE_DEVICES=4,5,6,7 torchrun --nproc-per-node=4 train_ddp.py --rank 4