...
parser.add_argument('--ckpt_path', type=str, default="model_batch512_4ceng/best_loss_model.pth")
parser.add_argument('--output_dir', type=str,default="model_batch512_4ceng",)
parser.add_argument('--gpu_id', type=str, default='5', help='gpu id')
parser.add_argument('--output_file', type=str, default="location_best_loss_100wan_plus.index.json")
args = parser.parse_args()


# "Directly modify the path in datasets.py"
