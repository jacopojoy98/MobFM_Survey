...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str,
                        default="lllm_emb/all_citys_emb_plus.npy",
    ...
    parser.add_argument('--num_emb_list', type=int, nargs='+', default=[512,512,512,512], help='emb num of every vq')
    ...
    parser.add_argument("--ckpt_dir", type=str, default="model_batch1024_4ceng_code512", help="output directory for model")
